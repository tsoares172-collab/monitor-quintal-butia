...
def check_website():
    # Cria o scraper que simula um navegador real para evitar bloqueios (403/Cloudflare)
    ...
    if current_hash != previous_hash:
        ...
        if previous_hash != "":
            ...
            print("Primeira execução concluída! O estado atual da agenda foi saved.")
    else:
